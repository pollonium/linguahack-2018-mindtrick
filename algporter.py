...
class Porter:
    ...
    NOUN = re.compile(
        u"(а|ев|ов|ие|ье|е|иями|ями|ами|еи|ии|и|ией|ей|ой|ий|й|иям|ям|ием|ем|ам|ом|о|у|ах|иях|ях|ы|ь|ию|ью|ю|ия|ья|я|ость|ост|ек|енок)$")
...
if __name__ == '__main__':
    print (Porter.stem(u'коллективный'))